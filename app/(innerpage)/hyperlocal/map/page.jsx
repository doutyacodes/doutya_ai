...
// Add this new component before your main NewsMap component

// const CreatorButton = ({ isMobile, buttonStyle, isFilterExpanded }) => {
...
//   if (isMobile) {
//     // Mobile: Smaller round icon button at bottom right corner, above map controls
//     return (
//       <div className="fixed bottom-52 right-3 z-10">
//         <button 
//           onClick={handleCreatorClick}
//           className="bg-red-600 hover:bg-red-700 text-white shadow-lg rounded-full p-2 transition-colors duration-200 flex items-center justify-center"
//           title="Be a Creator"
//         >
//           <svg 
//             width="18" 
...
//   // Desktop: Button to the left of filter button, moves when filter expands
//   return (
//     <div className={`absolute top-3 z-10 transition-all duration-300 ${isFilterExpanded ? 'right-72' : 'right-36'}`}>
//       <button 
//         onClick={handleCreatorClick}
