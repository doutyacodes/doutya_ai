      ...
      {/* <div className="w-full max-w-[90vw] mb-3 mx-8">
        {showNews && showId ? (
          <button
            ...
            className="flex items-center gap-3 px-6 py-3 text-base font-semibold text-white bg-orange-500 rounded-full hover:bg-orange-600 transition-all duration-200 shadow-md hover:shadow-lg active:scale-95 md:text-lg md:px-8 md:py-4"
          >
