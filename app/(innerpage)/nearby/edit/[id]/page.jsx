...
useEffect(() => {
  ...
  const fetchExistingData = async (id) => {
    setLoading(true);
    try {
      const res = await fetch(`/api/hyperlocal/edit/${id}?type=${type}`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedMainCategory === 'classified') {
        ...
        endpoint = `/api/hyperlocal/classified/${editId}`;
        dataToSubmit = {
          ...classifiedData,
          images: allImages,
        ...
        endpoint = `/api/hyperlocal/obituary/${editId}`;
        dataToSubmit = {
          ...obituaryData,
          image_url: imageUrl,
          images_to_delete: imagesToDelete,
        ...
        endpoint = `/api/hyperlocal/${editId}`;
        dataToSubmit = {
          ...newsData,
          image_url: imageUrl,
          // images_to_delete: imagesToDelete,
