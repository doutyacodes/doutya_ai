...
const FAQPage = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'Unlike traditional news platforms that often present single perspectives, Doutya uses AI to analyze and present multiple viewpoints on every story. This helps readers break out of echo chambers and gain a comprehensive understanding of complex issues.',
      popular: true
    },
    {
      id: 3,
      ...
      answer: 'AI Debates allow you to engage in discussions with different AI personalities (Scholar, Advocate, Skeptic, Visionary) on various topics. Each AI has distinct characteristics and approaches to argumentation, providing diverse perspectives on the subjects you want to explore.',
      popular: true
    },
    {
      id: 4,
      ...
      answer: 'Yes! Pro and Elite members can save articles, create custom folders, and organize their content for future reference. You can also add personal notes to saved articles and share your collections with others.',
      popular: false
    },
    {
      id: 5,
      ...
      answer: 'Our interactive News Map visualizes global events geographically, allowing you to explore news by location. You can see trending stories in different regions, understand local perspectives, and track how events spread across different areas.',
      popular: false
    },
    {
      id: 6,
      ...
      answer: 'We offer three plans: Starter (free with basic features), Pro (₹299/month with AI debates and advanced features), and Elite (₹599/month with unlimited access and premium features). All plans include our core multi-perspective news analysis.',
      popular: true
    },
    {
      id: 7,
    ...
    },
    {
      ...
      answer: 'Yes! We offer 50% discounts for students and educational institutions. Contact our support team with valid student ID or institutional email to apply for the discount.',
      popular: false
    },
    {
      id: 9,
      ...
      answer: 'Creating an account is simple! Click "Sign Up" on our homepage, enter your email and create a password. You can also sign up using your Google or social media accounts for faster registration.',
      popular: false
    },
    {
      id: 10,
      ...
      answer: 'Absolutely! You can upgrade or downgrade your plan anytime from your account dashboard. Changes take effect immediately for upgrades, or at the next billing cycle for downgrades.',
      popular: false
    },
    {
      id: 11,
      ...
      answer: 'We take privacy seriously and use industry-standard encryption to protect your data. We never sell personal information to third parties and only collect data necessary to improve your experience. Read our Privacy Policy for complete details.',
      popular: true
    },
    {
      id: 12,
      ...
      answer: 'We collect anonymous analytics to improve our platform and personalize your experience. You can opt out of tracking in your privacy settings, and we never share individual reading patterns with external parties.',
      popular: false
    },
    {
      id: 13,
      ...
      answer: 'Doutya works on all modern browsers (Chrome, Firefox, Safari, Edge) and devices (desktop, tablet, mobile). We also have mobile apps for iOS and Android. Our platform is optimized for responsive design across all screen sizes.',
      popular: false
    },
    {
      id: 14,
      ...
      answer: 'We offer API access for Enterprise customers and partners. Our API provides access to our news analysis engine and perspective generation capabilities. Contact our business team to learn more about API access and pricing.',
      popular: false
    },
    {
      id: 15,
      ...
      answer: 'Our AI achieves 99.9% accuracy in source verification and perspective analysis. We continuously train our models on diverse datasets and have human editorial oversight to ensure quality and reduce bias in our analysis.',
      popular: true
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about Doutya&apos;s features, pricing, 
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
              {[
                { number: '95%', label: 'Questions Resolved', icon: CheckCircle },
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            >
              <div className="bg-white rounded-3xl border border-gray-200 p-8 sticky top-8">
                <h3 className="font-bold text-gray-900 mb-8 text-xl">Categories</h3>
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            {supportOptions.map((option, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 group-hover:text-red-600 transition-colors">{option.title}</h3>
                <p className="text-gray-600 mb-8 leading-relaxed">{option.description}</p>
                <motion.button 
                  whileHover={{ scale: 1.05, boxShadow: "0 10px 30px -5px rgba(239, 68, 68, 0.3)" }}
                  whileTap={{ scale: 0.95 }}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-3xl font-bold text-gray-900 text-center mb-12">Helpful Resources</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {helpfulResources.map((resource, index) => (
                ...
                >
                  ...
                  <h4 className="font-bold text-gray-900 mb-3 group-hover:text-red-600 transition-colors">{resource.title}</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          >
            ...
            <p className="text-xl mb-12 max-w-3xl mx-auto opacity-90 leading-relaxed">
              Our friendly support team is always ready to help you get the most out of Doutya. 
