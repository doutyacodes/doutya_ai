        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              {[{name: "Features", href: "#features"}, {name: "About", href: "/about"}, {name: "Careers", href: "/careers"}, {name: "FAQ", href: "/faq"}, {name: "Pricing", href: "#pricing"}, {name: "Success Stories", href: "#success-stories"}].map((item, index) => (
                <motion.a
                  key={item.name}
                  href={item.href}
          ...
          {isMenuOpen && (
            ...
            >
              <div className="px-4 py-6 space-y-4">
                {[{name: "Features", href: "#features"}, {name: "About", href: "/about"}, {name: "Careers", href: "/careers"}, {name: "FAQ", href: "/faq"}, {name: "Pricing", href: "#pricing"}, {name: "Success Stories", href: "#success-stories"}].map(
                  (item, index) => (
                    <motion.a
                      key={item.name}
                      href={item.href}
            ...
            >
              ...
              <ul className="space-y-4 text-gray-400">
                {[
                  ...
                  { name: "Success Analytics", href: "/features" },
                ].map((item) => (
                  <li
                    key={item.name}
