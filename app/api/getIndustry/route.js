...
export async function GET(req) {
  ...
  const prompt = `Provide a list of the 3 normal, 3 trending, and 3 off-beat sectors  for an individual with RIASEC interest types of ${type2}${type3 ? " and Gallup Strengths types of " + type3 : ""
